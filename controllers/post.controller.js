...
const fs = require("fs"); // pour le traitement des fichiers
const { promisify } = require("util"); // pour la conversion des fichiers
...
module.exports.readPost = (req, res) => {
  PostModel.find((err, docs) => {
    ...
    else console.log("Erreur pour recupérer les données: " + err);
  }).sort({ createdAt: -1 });
};
